...
// Copyright (c) 2009-2012 The Stratis Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Stratis/$1-%s The Stratis/' %s"
REGEX_CURRENT= re.compile("%s The Stratis" % year)
