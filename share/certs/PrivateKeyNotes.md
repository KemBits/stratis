...
unlocked to sign the Stratis-Qt.app bundle.
...
allowing somebody to distribute a Stratis-Qt.app or stratis-qt-setup.exe with a valid
...
that the stratis-qt.exe file inside the installer had not been tampered with.
