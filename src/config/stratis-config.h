/* src/config/stratis-config.h.  Generated from stratis-config.h.in by configure.  */
/* src/config/stratis-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef STRATIS_CONFIG_H

#define STRATIS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Stratis Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Stratis Core"
...
#define PACKAGE_BUGREPORT "https://github.com/stratis/stratis/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Stratis Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Stratis Core 0.12.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "stratis"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://stratiscore.org/"
