...
#ifndef STRATIS_QT_STRATISUNITS_H
#define STRATIS_QT_STRATISUNITS_H
...
/** Stratis unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StratisUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StratisUnits(QObject *parent);

    /** Stratis units.
      @note Source: https://en.stratis.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        STRA,
...
typedef StratisUnits::Unit StratisUnit;

#endif // STRATIS_QT_STRATISUNITS_H
