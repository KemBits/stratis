...
#include "config/stratis-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatStratisURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + StratisUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatStratisURI(info));
}
