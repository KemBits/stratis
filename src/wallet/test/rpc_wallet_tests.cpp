// Copyright (c) 2013-2015 The Stratis Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CStratisAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CStratisAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CStratisAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CStratisAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CStratisAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CStratisAddress(arr[0].get_str()).Get() == demoAddress.Get());
