...
#ifndef STRATIS_TEST_SCRIPTNUM10_H
#define STRATIS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Stratis Core 0.10.0, for cross-comparison.
 */
public:
