...
#define BOOST_TEST_MODULE Stratis Test Suite

#include "test_stratis.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_stratis_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
