Stratis version 0.5.4 is now available for download at:
http://sourceforge.net/projects/stratis/files/Stratis/stratis-0.5.4/
...
http://gitorious.org/stratis/stratisd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Stratis-Qt notifications under Growl 1.3.
Increase required age of Stratis-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxStratis properly when installing Stratis-Qt over it. (Windows)
