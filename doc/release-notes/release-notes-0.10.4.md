Stratis Core version 0.10.4 is now available from:

  <https://stratis.org/bin/stratis-core-0.10.4/>
...
- #6953 `43c2789` Split stratis-tx into its own package
- #6953 `dfe0d4d` Include stratis-tx binary on Debian/Ubuntu
