Stratis-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/stratis/files/Stratis/stratis-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Stratis
...
New/changed settings (command-line or stratis.conf file)
--------------------------------------------------------
