Stratis Core version 0.9.4 is now available from:

  https://stratis.org/bin/0.9.4/
...
this update is incompatible with the Stratis system and could lead to consensus
forks.

Stratis Core released binaries from https://stratis.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~stratis/+archive/ubuntu/stratis
- A third-party or self-compiled Stratis Core

upgrade to Stratis Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
