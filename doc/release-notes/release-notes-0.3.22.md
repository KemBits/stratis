Download URL: https://sourceforge.net/projects/stratis/files/Stratis/stratis-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 STRA fee schedule (users still pay 0.01 STRA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #stratis00 - #stratis99
