Stratis Core version 0.9.2.1 is now available from:

  https://stratis.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 STRA to 0.01 STRA
...
- Fix "Start stratis on system login"
